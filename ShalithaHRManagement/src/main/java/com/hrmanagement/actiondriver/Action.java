 ...
 * 
 */
package com.hrmanagement.actiondriver;
...
import com.hrmanagement.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String destination = System.getProperty("user.dir") + "\\ScreenShots\\" + dateName + "_" + filename + ".png";
		...
		String newImageString = "http://localhost:8082/job/ShalithaHRManagement/ws/ShalithaHRManagement/ScreenShots/" + dateName + "_"
				+ filename + ".png";
